...
const ContactOwnerModal = ({
    ...
    const handlePayment = async () => {
        ...
        setTimeout(async () => {
            ...
            try {
                ...
                if (result.success) {
                    // Create payment result for modal
                    const paymentResultData: PaymentResult = {
                        success: true,
                        ...
                        planType: listingType === "room" ? "Booking" : planType,
                        duration: listingType === "room" ? paymentFormData.stayDuration : paymentFormData.subscriptionDuration,
                    };
    ...
    const handleDownloadReceipt = async () => {
        if (paymentResult) {
            await downloadReceiptPDF(paymentResult);
        }
    };
    ...
    const handleEmailReceipt = async () => {
        if (paymentResult) {
            await emailReceipt(paymentResult);
        }
    };
